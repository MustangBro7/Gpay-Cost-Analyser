/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 9157ccd20837f8a81e16c42be4290f1f)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		FRONTEND_ORIGIN: "https://app.gpayanalyze.co.in";
		FRONTEND_ORIGINS: "https://app.gpayanalyze.co.in,https://gpay-cost-analyser-lok3.vercel.app,http://localhost:3000,http://127.0.0.1:3000,http://localhost:3001,http://127.0.0.1:3001";
		GOOGLE_OAUTH_REDIRECT_URI: "https://api.gpayanalyze.co.in/oauth2callback";
		GOOGLE_PUBSUB_TOPIC_NAME: "projects/directed-graph-394817/topics/gpay-cost-analyser-gmail";
		HDFC_SENDERS: "alerts@hdfcbank.net,alerts@hdfcbank.bank.in";
		GOOGLE_GEMINI_MODEL: "gemini-2.5-flash-lite-preview-06-17";
	}
}
